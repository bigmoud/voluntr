...
function generateSimplifiedSQLInserts() {
  console.log('📝 Generating simplified SQL INSERT statements...\n');
  
  console.log('-- Simplified SQL INSERT statements for events table');
...
if (require.main === module) {
  generateSimplifiedSQLInserts();
}

module.exports = { generateSimplifiedSQLInserts }; 